...
function formScroll() {
  if (contactWrapperRef.value) {
    // const offset = 500; // Adjust this value to control how much less it should scroll
    const targetScrollPosition = contactWrapperRef.value.offsetTop
...
<template>
  <main class="home-page">
      ...
      <div class="about-me-content">
        <div class="about-me-left">
          ...
          <div class="about-me-left-inner">
            <p>I am a 24 year old fullstack engineer with a background in computer science and data. I love working goal
              oriented
        ...
        <div class="about-me-right">
          ...
          <a href="https://www.instagram.com/julius_blr/" target="blank" class="social social-1"
            :class="{ 'social-show-1': isAnimationActive, 'social-hide-1': !isAnimationActive }"><svg
              ...
              <g fill-opacity="0" fill="#cdd7f7" fill-rule="nonzero" stroke="none" stroke-width="1"
                stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray=""
                stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none"
                style="mix-blend-mode: normal">
                <path d="M115.2,140.8v-25.6h25.6v25.6z" id="shape"></path>
              </g>
    ...
    <div class="contact-wrapper" ref="contactWrapperRef">
      <ContactForm :class="{ 'formFadeIn': !showForm, 'formFadeOut': showForm }" class="contactForm"
        ref="contactForm" />
    </div>
  </main>
</template>
